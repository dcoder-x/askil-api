...
const sendSellerVerificationEmail = async (email, token) => {
  // Define the email content
  let mailOptions = {
    from: 'mazamaza.com" <ayomikunfaluyi@gmail.com>',
    to: email,
              ...
              <table role="presentation" style="width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-family:'Basier Circle', 'Roboto', 'Helvetica', 'Arial', sans-serif;font-size:1em;line-height:1.37em;color:#384049;">
                ...
                <tr>
                  <td style="padding:40px 30px 30px 30px;text-align:center;font-size:1.5em;font-weight:bold;">
                       <img width="2170" alt="Mazamaza" style="width:2170px;max-width:80%;height:auto;border:none;text-decoration:none;color:#ffffff;" src="">
                  </td>
                </tr>
                <!--      Intro Section -->
                <tr>
                  <td style="padding:30px;background-color:#ffffff;">
                    <h1 style="margin-top:0;margin-bottom:1.38em;font-size:1.953em;line-height:1.3;font-weight:bold;letter-spacing:-0.02em;">Verify your email</h1>
                    <p style="margin:0;">Congratulations on completing the first phase or your Mazamaza seller registration,</p>
                    <p>The next important step is to verify your email account</p>
                    <p>Your account may not be approved by the admin if your account is not verified.</p>
                    <p>To verify your email, please click on this link:</p>
                    <p style="text-align: center;margin: 2.5em auto;">
                      <a class="button" href="https://mazamaza.onrender.com/api/seller/verify/?token=${token}" style="background: #DE4D3B; 
                ...
                <tr>
                  <td style="padding:30px;text-align:center;font-size: 0.75em;background-color:#ffeada;color:#384049;border: 1em solid #fff;">
                    <p style="margin:0 0 0.75em 0;line-height: 0;">
                      ...
                      <!--     Instagram logo               -->
                      <a href="https://www.instagram.com/dopplerhealth/" style="display:inline-block;text-decoration:none;margin: 0 5px;">
...
const sendBuyerVerificationEmail = async (email, token) => {
  // Define the email content
  let mailOptions = {
    from: 'mazamaza.com" <ayomikunfaluyi@gmail.com>',
    to: email,
          ...
          <tr>
            <td align="center" style="padding:0;">
              ...
              <table role="presentation" style="width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-family:'Basier Circle', 'Roboto', 'Helvetica', 'Arial', sans-serif;font-size:1em;line-height:1.37em;color:#384049;">
                ...
                <tr>
                  <td style="padding:40px 30px 30px 30px;text-align:center;font-size:1.5em;font-weight:bold;">
                      <img width="2170" alt="Doppler Health" style="width:2170px;max-width:80%;height:auto;border:none;text-decoration:none;color:#ffffff;" src="https://christianreal.onrender.com/assets/logo.140734ce.png">
                  </td>
                </tr>
                <!--      Intro Section -->
                <tr>
                  <td style="padding:30px;background-color:#ffffff;">
                    ...
                    <p>Welcome to Mazamaza.com the NO 1 marketplace for African made products</p>
                    <p>Please verify your email acount to keep enjoying our services .</p>
                    <p>To verify your email, please click on this link:</p>
                    <p style="text-align: center;margin: 2.5em auto;">
                      <a class="button" href="http://localhost:4000/users/verify/?token=${token}" style="background: #DE4D3B; 
                           text-decoration: none; 
                           padding: 1em 1.5em;
                           color: #ffffff; 
                           border-radius: 48px;
          ...
          <tr>
            <td align="center" style="padding:0;">
              ...
              <table role="presentation" style="width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-family:'Basier Circle', 'Roboto', 'Helvetica', 'Arial', sans-serif;font-size:1em;line-height:1.37em;color:#384049;">
                ...
                <tr>
                  <td style="padding:30px;background-color:#ffffff;">
                    <h1 style="margin-top:0;margin-bottom:1.38em;font-size:1.953em;line-height:1.3;font-weight:bold;letter-spacing:-0.02em;">Password Reset</h1>
                    <p style="margin:0;">Hi 🔒,</p>
                    <p>You are trying to change your password</p>
                    <p>Please verify this action was initiated by you .</p>
                    <p>To verify, please click on this link:</p>
                    <p style="text-align: center;margin: 2.5em auto;">
                      <a class="button" href="https://christianreals-backend.onrender.com/resetPassword/verify/?token=${token}" style="background: #DE4D3B; 
                           text-decoration: none; 
                           padding: 1em 1.5em;
                           color: #ffffff; 
                           border-radius: 48px;
...
const sendEventRegistrationEmail = async (email, event) => {
  // Define the email content
  let mailOptions = {
    from: 'mazamaza.com" <ayomikunfaluyi@gmail.com>',
    to: email,
              ...
              <table role="presentation" style="width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-family:'Basier Circle', 'Roboto', 'Helvetica', 'Arial', sans-serif;font-size:1em;line-height:1.37em;color:#384049;">
                ...
                <tr>
                  <td style="padding:30px;background-color:#ffffff;">
                    ...
                    <p style="margin:0;">Hi 😊,</p>
                    <img width="2170" alt="Doppler Health" style="width:2170px;max-width:80%;height:auto;border:none;text-decoration:none;color:#ffffff;" src=${
                      event.imageUrl
                    } alt=${event.title}>
                    <p>You are now registered as a participant to the ${
                      event.title
                    }.</p>
                ...
                <tr>
                  <td style="padding:30px;text-align:center;font-size: 0.75em;background-color:#ffeada;color:#384049;border: 1em solid #fff;">
                    ...
                    <p style="margin:0;font-size:.75rem;line-height:1.5em;text-align: center;">
                      Christianreals, 800 Woodlands Parkway, Suite 118, Ridgeland, MS 39157
                      <br>
